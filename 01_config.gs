...
var ATIVIDADES_CFG = Object.freeze({
  ...
  JUSTIFICATIVAS: Object.freeze({
    PRE_ACTIVITY_ANALYSIS_STATUS: 'PREVIA',
    PRE_ACTIVITY_WINDOW_DAYS: 7,
  ...
  APRESENTACOES_JOB: Object.freeze({
    ...
    COBRANCA_TITULO_EIXO_INTERVALO_HORAS: 24,
    TITULO_EIXO_INBOX_SUBJECT: 'GEAPA | Envio de título e eixo da apresentação',
    TITULO_EIXO_INBOX_INGEST_DAYS: 15,
    TITULO_EIXO_INBOX_INGEST_MAX_THREADS: 12,
    TITULO_EIXO_INBOX_INGEST_MAX_MESSAGES_PER_THREAD: 6,
    CONFIRMACAO_PRESENCA_SUBJECT: 'GEAPA | Confirmação de presença em atividade',
    CONFIRMACAO_PRESENCA_INBOX_INGEST_DAYS: 15,
    CONFIRMACAO_PRESENCA_INBOX_INGEST_MAX_THREADS: 12,
    CONFIRMACAO_PRESENCA_INBOX_INGEST_MAX_MESSAGES_PER_THREAD: 6
  }),
  ...
  APRESENTACOES_POS_EVENTO: Object.freeze({
    ...
    COBRANCA_ARQUIVO_INTERVALO_HORAS: 24,
  ...
  APRESENTACOES_LOG_TYPES: Object.freeze({
    ...
    SOLICITACAO_CONFIRMACAO_CONVIDADO: 'SOLICITACAO_CONFIRMACAO_CONVIDADO',
    INBOX_CONFIRMACAO_CONVIDADO: 'INBOX_CONFIRMACAO_CONVIDADO',
  ...
  ATIVIDADES_GERAIS_JOB: Object.freeze({
    FLOW_CODE: 'ATIV_GERAL',
    LEMBRETE_DIAS_ANTES: 1,
    PENDENCIA_ATA_HORAS_APOS: 72,
    PENDENCIA_MATERIAL_HORAS_APOS: 72,
    EMAIL_GROUP_SECRETARIA: 'SECRETARIA',
    DIRECTOR_OCCUPATION_TOKENS: Object.freeze([
      'DIRETOR',
      'PRESIDENTE',
      'VICE PRESIDENTE',
      'VICE-PRESIDENTE',
  ...
  ATIVIDADES_GERAIS_LOG_TYPES: Object.freeze({
    CONVOCACAO: 'ATIVIDADE_GERAL_CONVOCACAO',
    LEMBRETE: 'ATIVIDADE_GERAL_LEMBRETE',
    UPSERT_CONVIDADOS: 'ATIVIDADE_GERAL_UPSERT_CONVIDADOS',
    AUTO_REALIZADA: 'ATIVIDADE_GERAL_AUTO_REALIZADA',
    PENDENCIA_ATA: 'ATIVIDADE_GERAL_PENDENCIA_ATA',
    PENDENCIA_MATERIAL: 'ATIVIDADE_GERAL_PENDENCIA_MATERIAL'
  }),
  ...
  PLANNING: Object.freeze({
    BASE_DEFAULT: 'SIM',
    PERIOD_SYNC_STATUSES: Object.freeze(['CONFIRMADA', 'CONVITES_LIBERADOS', 'REALIZADA'])
  })
});
