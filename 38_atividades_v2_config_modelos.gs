...
var ATIVIDADES_CONFIG_MODELOS_NEW_HEADERS_ = Object.freeze([
  ...
  'TIPOS_ARQUIVO_FOTO_REUNIAO_PERMITIDOS',
  'TAMANHO_MAX_FOTO_REUNIAO_MB',
  'PERFIS_QUE_PODEM_ENVIAR_FOTO_REUNIAO',
  'PERMITE_MEMBRO_APRESENTADOR_ENVIAR_FOTO_REUNIAO',
  'PRAZO_FOTO_REUNIAO_HORAS_APOS',
...
function atividades_validarSchemaAtividadesConfig_() {
  ...
  if (!sheet) {
    return {
      ...
      message: 'A aba Atividades_Config nao foi encontrada na base v2 do ambiente resolvido.',
      colunasEncontradas: [],
      ...
      colunasDuplicadas: [],
      mensagens: ['Aba Atividades_Config ausente na base v2 do ambiente resolvido.'],
...
function atividades_configModelosRequireSheet_(ss) {
  var sheet = ss.getSheetByName(ATIVIDADES_V2_SHEETS.CONFIG);
  if (!sheet) throw new Error('Aba Atividades_Config nao encontrada na base v2 do ambiente resolvido.');
  return sheet;
}
...
function atividades_configModeloApresentacaoMembroValues_() {
  return {
    ...
    GERA_PENDENCIA_TITULO_EIXO: 'SIM',
    GERA_PENDENCIA_MATERIAL: 'SIM',
    EXIGE_MATERIAL_PADRAO: 'SIM',
    PERMITE_UPLOAD_MATERIAL: 'SIM',
    PERMITE_LINK_MATERIAL: 'SIM',
    TIPOS_ARQUIVO_MATERIAL_PERMITIDOS: 'PDF,PPT,PPTX,ODP',
    TAMANHO_MAX_MATERIAL_MB: 20,
    INSTRUCAO_UPLOAD_MATERIAL: 'Envie o slide ou material que sera usado na sua apresentacao.',
    EXIGE_FOTO_REUNIAO: 'SIM',
    GERA_PENDENCIA_FOTO_REUNIAO: 'SIM',
    PERMITE_UPLOAD_FOTO_REUNIAO: 'SIM',
    PERMITE_LINK_FOTO_REUNIAO: 'SIM',
    TIPOS_ARQUIVO_FOTO_REUNIAO_PERMITIDOS: 'JPG,JPEG,PNG,WEBP',
    TAMANHO_MAX_FOTO_REUNIAO_MB: 20,
    PERFIS_QUE_PODEM_ENVIAR_FOTO_REUNIAO: 'SECRETARIO,DIRETORIA,ADMIN_TECNICO',
    PERMITE_MEMBRO_APRESENTADOR_ENVIAR_FOTO_REUNIAO: 'SIM',
    PRAZO_FOTO_REUNIAO_HORAS_APOS: 72,
    PERMITE_DISPENSAR_FOTO_REUNIAO: 'SIM',
    USA_FLUXO_APRESENTACAO: 'SIM',
    EXIGE_PESSOA_PRINCIPAL: 'SIM',
    PAPEL_PADRAO_PESSOA_PRINCIPAL: 'APRESENTADOR',
    TIPO_PESSOA_PRINCIPAL_PADRAO: 'MEMBRO',
